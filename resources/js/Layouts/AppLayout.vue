                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('panel')">
                                    <ApplicationLogo class="block h-12 py-1 w-auto" />
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('resultados')" :active="route().current('resultados')">
                                    {{ $t('Resultados') }}
                                </NavLink>
                            </div>
                        </div>
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <div class="flex items-center" v-if="$page.props.jetstream.managesProfilePhotos">
                                            <span class="text-gray-500 text-sm font-medium max-w-max">{{ $page.props.auth.user.name }}</span> 
                                    ...
                                    <template #content>
                                        <!-- Account Management -->
                                        <div class="block px-4 py-2 text-sm text-prim font-bold">
                                            {{ $page.props.auth.user.name }}
                                        </div>
